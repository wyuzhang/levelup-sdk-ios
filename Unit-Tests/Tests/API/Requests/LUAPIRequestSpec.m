...
describe(@"LUAPIRequest", ^{
  ...
  describe(@"apiRequestWithMethod:path:parameters:modelFactory:", ^{
    it(@"returns a new LUAPIRequest with the given arguments", ^{
      LUAPIRequest *result = [LUAPIRequest apiRequestWithMethod:method path:path parameters:parameters modelFactory:modelFactory];
  ...
  describe(@"urlRequest", ^{
    beforeEach(^{
      apiRequest = [LUAPIRequest apiRequestWithMethod:method path:path parameters:parameters modelFactory:modelFactory];
    });
  ...
  describe(@"equality", ^{
    ...
    beforeEach(^{
      request1 = [LUAPIRequest apiRequestWithMethod:method path:path parameters:parameters modelFactory:modelFactory];
      request2 = [LUAPIRequest apiRequestWithMethod:method path:path parameters:parameters modelFactory:modelFactory];
    });
