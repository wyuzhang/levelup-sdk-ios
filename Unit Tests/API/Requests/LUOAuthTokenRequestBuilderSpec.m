...
SPEC_BEGIN(LUOAuthTokenRequestBuilderSpec)

describe(@"LUOAuthTokenRequestBuilder", ^{
  ...
  describe(@"requestToLoginWithEmail:password:", ^{
    ...
    beforeEach(^{
      request = [LUOAuthTokenRequestBuilder requestToLoginWithEmail:email password:password];
    });
  ...
  describe(@"requestToLoginWithFacebookAccessToken:", ^{
    ...
    beforeEach(^{
      request = [LUOAuthTokenRequestBuilder requestToLoginWithFacebookAccessToken:facebookAccessToken];
    });
