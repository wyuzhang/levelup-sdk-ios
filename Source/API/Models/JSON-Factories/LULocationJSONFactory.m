...
- (id)createFromAttributes:(NSDictionary *)attributes {
  ...
  return [[LULocation alloc] initWithCategoryIDs:categoryIDs descriptionHTML:descriptionHTML extendedAddress:extendedAddress hours:hours latitude:latitude
                                        locality:locality locationID:locationID longitude:longitude merchantID:merchantID
                                    merchantName:merchantName name:name phone:phone postalCode:postalCode region:region shown:shown
                                   streetAddress:streetAddress updatedAtDate:updatedAtDate webLocations:webLocations];
}
