...
/**
 ...
 - Each user has a unique referral code which they can share with their friends. If someone joins LevelUp using their
 ...
 Some campaigns can be shared by users. Currently, sharing by email, Facebook, and Twitter is supported. If the campaign
 allows sharing, the campaign will contain initial text that can be used to prefill the sharing dialogs.
 */
...
/**
 Specifies that the campaign is global, which means that it applies to all merchants -- if a user claims it, they will
 receive global credit that can be used at any LevelUp merchant.
 */
