...
/**
 A unique access token returned by the server after authentication succeeds. In order for users to remain authenticated
 between application launches, this value should be securely stored. See `LUAPIClient` for more information.
 */
